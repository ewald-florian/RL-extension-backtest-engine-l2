# Copy of the original replay.py file which contains
# the adaptions for rl training
...
class Backtest:
    ...
    def __init__(self,
        ...
        # from arguments
        self._agent = agent # store original agent to reset agent after episode
    ...
    def market_step(self, market_id, book_update, trade_update):
        """
    ...
    def agent_step(self, source_id, either_update, timestamp, timestamp_next):
        """
        ...
        if source_id.endswith("BOOK"):
            # TODO: Warum kann backtest auf agent zugreifen?
    ...
    def run(self, 
        ...
        for step, update_store in enumerate(episode, start=1):
            ...
            for market_id in market_list:
                self.market_step(market_id=market_id,
            ...
            for source_id in source_list: 
                self.agent_step(source_id=source_id,
